...
const SocialSharing: React.FC<SocialSharingProps> = ({
  ...
  const shareText = `${product.name} - ${product.price} جنيه`;
  const shareDescription = product.description || product.name;
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <span className="text-sm font-medium text-gray-700">شارك:</span>
      <div className="flex items-center gap-2">
        {settings.shareFacebook && (
          <button
