...
router.get('/facebook-pages', verifyToken.authenticateToken, commentController.getFacebookPages);
router.get('/facebook-pages/:pageId/posts', verifyToken.authenticateToken, commentController.getPostsByPageId);
router.post('/facebook-pages/:pageId/response-method', verifyToken.authenticateToken, commentController.setPageResponseMethod);
router.get('/facebook-pages/:pageId/response-method', verifyToken.authenticateToken, commentController.getPageResponseMethod);
