...
router.post('/generate-embeddings', verifyToken.authenticateToken, productController.generateEmbeddings);
...
router.put('/:id/variants/:variantId', verifyToken.authenticateToken, productController.updateProductVariant);
